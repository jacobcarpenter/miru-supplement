export function ChevronHex({ width = 18, height = 18, limit }: { width?: number; height?: number; limit?: number }) {
	return (
		<svg width={`${width}px`} height={`${height}px`} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M3,3 L9,6 15,3 15,11 9,14 3,11 Z" stroke="#999" fill="#999" stroke-width="3" stroke-linejoin="round" />
			{limit && (
